import { useState, useRef, FormEvent, SetStateAction } from 'react';
...
const App = () => {
  ...
  const setSaveItems = (item: SetStateAction<TypeItems[]>) => {
    setItems(item);
